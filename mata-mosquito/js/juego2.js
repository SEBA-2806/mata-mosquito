...
var nivel = windows.location.search;
nivel = nivel.replace("?", "");
...
function posicaoRandomica() {
    if (document.getElementById("mosquito")) {
        ...
        if (vidas > 3) {
            windows.location.href = "fin_del_juego.html";
        } else {
    ...
    var posicionY = Math.floor(Math.floor() * altura) - 90;
...
function tamanoAleatorio() {
    var clase = Mathfloor(Math.random() * 3)
